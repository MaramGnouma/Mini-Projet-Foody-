...
export class FoodServiceService {
  ...
  addFood(food: any): Observable<any> {
    ...
    return this.http.post(`${this.apiUrl}/foods`, food, { headers: { 'Content-Type': 'application/json' } });
  }
  ...
  getFoodsBySpecificType(specificType: string): Observable<Food[]> {
    const url = `${this.apiUrl}/foods/specificType/${specificType}`;
    return this.http.get<Food[]>(url);
  }
}
